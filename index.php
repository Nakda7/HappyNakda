...
<body>
	...
	<header>
        ...
        <a class="header-a" href="../HappyNakda/index.php">
        ...
        <a class="perfil-index" href="../HappyNakda/perfil/mi_perfil.php">
            <div class="perfil-contenedor">
                <img class="logo-perfil" src="../HappyNakda/img/perfillogo.png" alt="">
            </div>
        </a>


        <a class="carrito-index" href="../HappyNakda/catalogo/carrito.php">
            <div class="carrito-contenedor">
                <img class="logo-carrito" src="../HappyNakda/img/carritologo.png" alt="">
            </div>
        </a>

        <a class="login-index" href="../HappyNakda/login/InSesion.php">
            <div class="login-contenedor">
                <img class="logo-login" src="../HappyNakda/img/logologin.png" alt="">
            </div>
        </a>
    ...
    <div class="contenedor-navegacion">
        ...
        <div class="dropdown">
            ...
            <a href="../HappyNakda/catalogo/catalogo1.php"><p>Querétaro</p></a>
            <a href="../HappyNakda/catalogo/catalogo2.php"><p>Monterrey</p></a>
            <a href="../HappyNakda/catalogo/catalogo3.php"><p>Guadalajara</p></a>
            </div>
    ...
    <div class="banner-registrarse">
            <p>¿Eres cliente nuevo?  <a class="text-registrate" href="../HappyNakda/register/registro.php"> Regístrate ahora</a></p>
            <img class="banner-logo-registrarse" src="../HappyNakda/img/flecha-correcta.png" alt="">
