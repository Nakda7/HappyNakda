...
// Realizar la consulta para obtener los productos de la Sucursal 2
$sql = "SELECT tproductos.*, tinventarios.in_cantidad
        FROM tproductos
        INNER JOIN tinventarios ON tproductos.id_producto = tinventarios.id_producto
        WHERE tinventarios.id_sucursal = 2";

$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // Mostrar los productos de la Sucursal 2 en forma de tabla
    echo "<h3>Productos de la Sucursal 2:</h3>";
    echo "<table>";
    ...
    echo "No se encontraron productos para la Sucursal 2";
}
